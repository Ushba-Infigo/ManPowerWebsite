...
const GetConsultationBannerData = () => { 
  ...
  useEffect(() => {
    const fetchCallToAction = async () => {
      try {
        ...
        console.error("Error fetching CallToAction data:", error);
      }
    };
  ...
  if (!callToAction) return null; // or a loader

  return (
    <>
      <br />
      <div className="banner-container" style={{ padding: "0 30px" }}>
        ...
        <div className="banner" style={{ marginTop: '-19%' }}>
          <div className="banner-content">
            <div className="row">
              <div className="banner-left col-md-8">
                ...
                <p style={{ color: "white" }}>
                  <span>Our team is ready to assist you with any concerns. Call us now and get immediate support!</span>
                </p>
              </div>
