...
const GetContactUsData = () => {
  ...
  return (
    <>
      ...
      >
        <div className="build abtsetting">{data?.Heading} </div>
      </div>

      {/* Contact Section */}
      <div className="contact-wrapper abtsetting">
        <div className="row contact-section">

          {/* Left Side */}
          <div className="col-lg-4 col-md-5 contact-left" style={{ marginTop: "-40px" }}>
            <h4 className="contact-title">{data?.Title}</h4>
            <br />

            {/* Location */}
            <div className="contact-card">
              <svg className="nos" width="30" height="36" viewBox="0 0 30 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
