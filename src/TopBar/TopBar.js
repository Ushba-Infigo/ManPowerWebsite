          ...
          <div className="collapse navbar-collapse" id="mainNavbar">
            <ul className="navbar-nav mx-lg-auto mb-2 mb-lg-0 gap-lg-3">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu inner-dropdown">
                  <li><Link className="dropdown-item" to="/GetIndustrydetailByName/Telecommunication">Telecommunication</Link></li>
                  <li><Link className="dropdown-item" to="/GetIndustrydetailByName/Information Technology">Information Technology</Link></li>
                  <li><Link className="dropdown-item" to="/GetIndustrydetailByName/Education">Education</Link></li>
                  <li><Link className="dropdown-item" to="/GetIndustrydetailByName/Healthcare">Healthcare</Link></li>
                </ul>
              </li>
            ...
            <li className="nav-item dropdown info inn globe-dropdown">
              ...
              <ul className="dropdown-menu dropdown-menu-end inner-dropdown" aria-labelledby="countryDropdown">
                <li><a className="dropdown-item" href="#" onClick={() => updateCountry('United Arab Emirates')}><img src="/img/ae.png" className="flag-icon" alt="UAE" /> United Arab Emirates</a></li>
                <li><a className="dropdown-item" href="#" onClick={() => updateCountry('United States of America')}><img src="/img/um.png" className="flag-icon" alt="US" /> United States</a></li>
                <li><a className="dropdown-item" href="#" onClick={() => updateCountry('Saudi Arabia')}><img src="/img/sa.png" className="flag-icon" alt="SA" /> Saudi Arabia</a></li>
                <li><a className="dropdown-item" href="#" onClick={() => updateCountry('Pakistan')}><img src="/img/pk.png" className="flag-icon" alt="PK" /> Pakistan</a></li>
              </ul>
            </li>
